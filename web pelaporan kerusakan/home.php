...
<head>
  ...
  <title>Web Pelaporan Kerusakan Fasilitas di Terminal Tegal</title>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="">Area Tunggu dan Bangku</a></h4>
              <p>Penerangan di area tunggu terbatas dan beberapa lampu tidak menyala.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="">Terminal pengecekan tiket</a></h4>
              <p>Mesin pengecekan tiket elektronik tidak berfungsi, menyebabkan antrian yang panjang dan keterlambatan proses pengecekan tiket</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="">Loket dan Pusat Infomasi</a></h4>
              <p>Beberapa loket pelayanan penjualan tiket tidak berfungsi, menyebabkan antrean yang panjang dan penundaan dalam mendapatkan tiket.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="">Area Parkir Kendaraan Pribadi</a></h4>
              <p>Penanda parkir yang jelas dan petunjuk arah yang kurang, menyebabkan kebingungan bagi pengguna kendaraan pribadi.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="">Infomasi jadwal dan pengumuman</a></h4>
              <p>Tidak ada petugas yang tersedia di pusat informasi, sehingga para penumpang kesulitan mendapatkan bantuan atau informasi yang mereka butuhkan</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="">Wastafel dan Toilet</a></h4>
              <p>Beberapa pintu toilet rusak dan tidak dapat dikunci dengan baik.</p>
            </div>
          </div>
